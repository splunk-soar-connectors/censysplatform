...
from censysplatform_consts import (
    CENSYSPLATFORM_CONNECTIVITY_ENDPOINT,
...
class CensysplatformConnector(BaseConnector):
    """
    Censysplatform connector class that serves as a starting point for new connectors.
    """
    ...
    def _handle_test_connectivity(self, param):
        ...
        endpoint = CENSYSPLATFORM_CONNECTIVITY_ENDPOINT
